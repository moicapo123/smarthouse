...
export default function Profile({ mustVerifyEmail, status }: { mustVerifyEmail: boolean; status?: string }) {
    ...
    useEffect(() => {
        console.log('🔍 Verificando permisos en Profile.tsx');
        console.log('Tiene view_profile:', hasPermission('view_profile'));
        console.log('Tiene edit_profile:', hasPermission('edit_profile'));
